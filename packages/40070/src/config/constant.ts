...
export const STEP_COLOR = '#F2F2F2';
export const STEP_ITEMS = ['选择科室', '选择医生', '选择时间'];
...
export const HOSPITAL_TEL = '023-63842837';
...
export const ADDRESS = {
  longitude: 106.57164982242983,
  latitude: 29.555445340928536,
  name: HOSPITAL_NAME,
  address: '渝中区新民街2号',
};
