...
export default () => {
  ...
  const homeSubNavConfig = [
    ...
    },
    {
      title: '体检预约',
      subTitle: '正规体检预约服务',
      url: 'pages2/register/department/index?type=health',
      image: `${IMAGE_DOMIN}/home/tjsc.png`,
      titleColor: '#EB7F70',
    },
    {
      title: '出生医学证明',
      subTitle: '自主预约快速办理',
      url: '/pages2/birthCredit/index',
  ...
  const homeCardNavConfig = useMemo(() => {
    const arr = [
      ...
      },
      {
        ...
        subTitle: '',
        url: '',
        image: `${IMAGE_DOMIN}/home/bafy1.png`,
        patientId: true,
      },
      {
        title: '院内导航',
        ...
        >
          {homeCardNavConfig.map((item: NavType) => (
            ...
            >
              ...
              {item.title === '病案复印' && (
                <WxOpenLaunchWeapp
                  username=" gh_222f2ca66020"
                  path="pages/index/index?hId=H0024"
                />
              )}
              {item.title === '电子票据' && (
                <WxOpenLaunchWeapp
