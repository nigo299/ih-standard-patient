...
const subPackages = [
  {
    ...
    pages: [
      ...
      'inhosp/reserve-list/index', // 住院预约记录列表
      'inhosp/reserve-detail/index', // 住院预约记录详情
      'inhosp/reserve-add/index', // 新增住院预约
      'inhosp/reserve-success/index', // 住院信息提交成功
      ...
      'price-inquiry/type/index', //物价查询选择项目
      'price-inquiry/search/index', //物价查询搜索页
