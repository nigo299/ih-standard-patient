...
import styles from 'commonHis/src/pages/microsite/home/index.less';
...
import OldViews from 'commonHis/src/pages/microsite/home/components/old-views';
import ShowMoreViews from 'commonHis/src/pages/microsite/home/components/show-more-views';
export default () => {
  ...
  return (
    <View className={styles.index}>
      ...
      <View className={styles['container-warp']}>
        ...
        <View className={styles['content-warp']}>
          <View className={styles['content-title-warp']}>
            <View className={styles.title}>采购专栏</View>
            <View
              className={styles.action}
              onTap={() => {
                ...
                navigateTo({
                  url: `/pages/microsite/hospital-article/index?type=${purchaseList?.[0]?.type}&title=采购专栏`,
                });
              }}
            >
              更多&gt;
