...
var SEQUENCE = Date.now(),
  noop = function () {},
  getCwarn = function () {
    const t = 'object' == typeof console ? console.warn : noop;
    try {
      const e = {
        warn: t,
      };
  ...
  util = {
    ...
    ignoreByRule: function (t, e) {
      if (!t || !e) return !1;
      if (
        ((this.isString(e) || e.source || 'Function' === this.T(e)) &&
          (e = [e]),
        !this.isArray(e))
      )
        return (
    ...
    verifyConfig: function (t) {
      if ('sample' in t) {
        let e = t.sample,
          n = e;
        e && /^\d+(\.\d+)?%$/.test(e) && (n = parseInt(100 / parseFloat(e))),
    ...
    serialize: function (t) {
      ...
      for (const n in t) {
        Object.prototype.hasOwnProperty.call(t, n) &&
          t[n] !== undefined &&
          e.push(n + '=' + this.encode(t[n], 'msg' === n));
      }
      return e.join('&');
    },
  ...
  Base = function (t) {
    return (
      ...
      (this.syn = 0),
      (this.err = 0),
      (this._conf = util.ext({}, Base.dftCon)),
      (this.sampleCache = {}),
      (this.requestQueue = []),
      (this.hash = util.seq()),
      this.resetSession(),
      this.setConfig(t),
      (this.rip = util.getRandIP()),
      (this._common = {}),
      this
    );
  };
(Base.dftCon = {
  ...
  (Base.prototype = {
    ...
    setCommonInfo: function (e) {
      e &&
        'object' == typeof e &&
        (this._common = util.ext({}, this._common, e));
    },
    ...
    sampling: function (e) {
      return (
        1 === e ||
        ('boolean' == typeof this.sampleCache[e]
          ? this.sampleCache[e]
          : ((this.sampleCache[e] = util.pick(e)), this.sampleCache[e]))
      );
    },
    clear: function () {
      let e,
      ...
      if (t.syn > 2) {
        return (
          clearTimeout(t.requestTimmer),
          (t.requestTimmer = setTimeout(function () {
            t.clear();
          }, 50)),
          t
        );
      ...
      for (
        clearTimeout(t.requestTimmer), t.requestTimmer = null;
        t.syn < 2 && (e = t.requestQueue.pop());
        t.syn++
      ) {
        'res' === e.t
          ? t.postData(e, 'res')
          ...
          ? t.postData(e, 'err')
          : 'behavior' === e.t
          ? t.postData(e, 'behavior')
          : t.sendRequest(e);
      }
      !!t.requestQueue.length &&
        (t.requestTimmer = setTimeout(function () {
          t.clear();
        }, 50));
      return this;
    ...
    _lg: function (e, t, i) {
      const n = this._conf,
        ...
        u = s.ignoreUrls,
        a = s.ignoreApis;
      return util.ignoreByRule(r, u) || util.ignoreByRule(util.decode(r), u)
        ? this
        : 'error' === e &&
          (util.ignoreByRule(t.msg, o) ||
            util.ignoreByRule(util.decode(t.msg), o))
        ? this
        : 'api' === e &&
          (util.ignoreByRule(t.api, a) ||
            util.ignoreByRule(util.decode(t.api), a))
        ? this
        : t && !n.disabled && (n.pid || n.token)
        ? i && !this.sampling(i)
          ? this
          : ((t = util.ext(
              {
    ...
    custom: function (e, t) {
      ...
      return (
        util.each(e, function (e, t) {
          return (
            !(i = t && t.length <= 20) &&
              util.warn('[CloudMonitor] invalid key: ' + t),
            (r['x-' + t] = e),
            i
          );
        }),
...
(Reporter.prototype = util_1.createObject(base.prototype)),
  util_1.ext(base.dftCon, {
    startTime: null,
  }),
  util_1.ext(Reporter.prototype, {
    ...
    error: function (t, e) {
      ...
      var r = t.name || 'CustomError',
        ...
        i = util_1.encode(
          util_1.replaceAll(t.stack || '', 'http.*\\d*:\\d*', 'unknow'),
        );
      e = e || {};
      var s = {
          begin: Date.now(),
      ...
      return (
        util.ignoreByRule(s.msg, n) || util.ignoreByRule(util.decode(s.msg), n)
          ? this
          : this.beforeSend && this.beforeSend('error', s),
        this._lg('error', s, 1)
      );
    },
    behavior: function (t) {
    ...
    api: function (e, t, r, i, a, s) {
      ...
      if (
        util.ignoreByRule(e.api, c) ||
        util.ignoreByRule(util.decode(e.api), c)
      )
        return this;
      ...
      return this._lg(
        'api',
        e,
        e.success && !e.response && this.getConfig('sample'),
      );
    },
...
const reporter = Reporter,
  MiniProgramLogger = function (t) {
    ...
    return (
      ...
      (o.DEFAUT_PAGE_PATH = '[app]'),
      (o.isSendPerf = !1),
      (o.beforeSend = function (e, t) {
        'error' === e
          ? o._health.errcount++
          : 'api' === e && o._health[t.success ? 'apisucc' : 'apifail']++;
      }),
      'function' == typeof o.autoSetCommonInfo && o.autoSetCommonInfo(),
      this
    );
  };
(MiniProgramLogger.prototype = util.createObject(Reporter.prototype)),
  util.ext(Reporter._root.dftCon, {
    sendRequest: function () {},
  ...
  util.ext(MiniProgramLogger.prototype, {
    ...
    sendRequest: function (e, o) {
      ...
      if (a.getConfig('debug') || a.err > 0) {
        'undefined' != typeof console &&
          ...
          console.log('[cloudMonitor] [DEBUG MODE] log data', e);
      } else {
    ...
    _lgPV: function (t) {
      ...
      !t.spmPre && (t.spmPre = util.toHex(this.getPage()) || ''),
        !t.spmId && (t.spmId = util.toHex(t.page) || ''),
        !t.scene && (t.scene = ''),
        this._lg('pv', t);
    },
    sendHealthOnPageShowOrHide: function () {
      try {
        (this.sessionPage = this.getPage()),
          this.sendHealth(),
          this.speedCache &&
    ...
    parseResponse: function (e) {
      ...
      let r = '',
        c =
          util.getPropertyValue(e, this._conf.code) ||
          e.stat ||
          e.status ||
          e.code ||
          e.success,
        u =
          util.getPropertyValue(e, this._conf.msg) ||
          e.msg ||
          e.message ||
          e.subMsg ||
          e.errorMsg ||
      ...
      'object' == typeof u &&
        ((c = c || u.code),
        (u = u.msg || u.message || u.info || u.ret || JSON.stringify(u)));
      return {
        code: c,
        msg: u,
...
(AlipayLogger.prototype = util.createObject(MiniProgramLogger.prototype)),
  util.ext(MiniProgramLogger._root.dftCon, {
    sendRequest: function (t, e, a) {
      if ('undefined' != typeof my && my && 'function' == typeof my.request) {
        try {
          let o,
            r = 'GET';
          e && ((r = 'POST'), (o = JSON.stringify(e))),
            my.request({
              url: t,
              method: r,
              data: o,
  ...
  util.ext(AlipayLogger.prototype, {
    ...
    autoSetCommonInfo: function () {
      this.setCommonInfo({
        ...
        this.autoSetNetworkType(),
        this.autoSetUid(),
        this.autoSystemInfo(),
        this.autoSetAppId(),
        this.autoSetSDKVersion(),
        this.autoSetRunScene();
    },
    autoSetUid: function () {
      const t = this;
    ...
    autoSystemInfo: function () {
      ...
      if (
        'undefined' != typeof my &&
        my &&
        'function' == typeof my.getSystemInfo
      ) {
        try {
          my.getSystemInfo({
            success: function (e) {
    ...
    autoSetNetworkType: function () {
      ...
      if (
        'undefined' != typeof my &&
        my &&
        'function' == typeof my.getNetworkType
      ) {
        try {
          my.getNetworkType({
            success: function (e) {
              e &&
                'string' == typeof e.networkType &&
                t.setCommonInfo({
                  net: e.networkType,
                });
            },
    ...
    autoSetAppId: function () {
      ...
      if (
        'undefined' != typeof my &&
        my &&
        'function' == typeof my.getAppIdSync
      ) {
        try {
    ...
    autoSetRunScene: function () {
      ...
      if (
        'undefined' != typeof my &&
        my &&
        'function' == typeof my.getRunScene
      ) {
        try {
          my.getRunScene({
            success(e) {
        ...
        (function () {
                  ...
                  if (i && i.url) {
                    ...
                    const p = {
                      success: function (t) {
                        ...
                        if (t.data && (!i.dataType || i.dataType === 'json')) {
                          ...
                          f &&
                            (u = util.ext(
                              u,
                              util.safetyCall(f, [i.data, t.data], {}),
                            ));
                        }
                        e.api(
                          util.ext(
                      ...
                      fail: function (t) {
                        ...
                        t &&
                          t.body &&
                          (u = (u = JSON.stringify(t.body)).substring(0, 256)),
                          e.api(
                            util.ext(
                              {
                                api: o,
          ...
          if (cp && 'undefined' != typeof my && my) {
            ...
            if ('function' == typeof my.navigateToMiniProgram) {
              ...
              a &&
                a.writable &&
                (my.navigateToMiniProgram = function (i) {
                  if (i) {
...
(AlipayLogger._super = miniProgramLogger),
  (AlipayLogger._root = miniProgramLogger._root),
