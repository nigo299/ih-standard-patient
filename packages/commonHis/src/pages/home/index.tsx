...
export default () => {
  ...
  const homeSubNavConfig = [
    ...
    },
    {
      ...
      image: `${IMAGE_DOMIN}/home/csyxzm.png`,
      // open: true,
    },
  ];
  ...
  const renderSubNav = (index: number) => {
    if (index === 0)
      return (
        <Space
          className={styles.navLeftConfig}
          vertical
          justify={'space-between'}
          onTap={() => handleNavClick(homeSubNavConfig[0])}
        >
          <Space vertical className={styles.navLeftConfigItem}>
            <Space
          ...
          <Space
            className={styles.navConfigBk}
            style={{ backgroundImage: `url(${IMAGE_DOMIN}/home/zyfw.png)` }}
          />
        </Space>
      );
    else if (index === 1)
      return (
        ...
        >
          {homeSubNavConfig
            .filter((_, innerIndex) => innerIndex !== 0)
            .map((item, innerIndex) => (
              <Space
                key={innerIndex}
                vertical
              ...
              >
                <Space
                  ...
                  alignItems="center"
                  justify="space-between"
                  style={{ color: innerIndex === 0 ? '#2EBDC7' : '#D5A068' }}
                >
                  {item.title}
                </Space>
                <Space
  ...
  return (
    <View>
      ...
      <Space vertical className={styles.content}>
        ...
        >
          {homeSubNavConfig.map((_, index: number) => renderSubNav(index))}
        </Space>
